...
{
  $sql="UPDATE avc SET Account_status='not active' WHERE AVC_ID='$AVC_ID'";
  if($conn->query($sql)===true)
  {
    $_SESSION['AVC_ID']=null;
    echo'<script> window.location.href="index.php"; </script>';
...
<html lang="en">
    <head>
        <title>AVS.com/AVC_page/<?php echo $user_name?></title>
        ...
        <script src="js/AVCscript.js"> </script>
        <style>
          .social-links a {
    font-size: 30px;
...
:is(.chat-box)::-webkit-scrollbar
  {
    ...
    <body class=""style="  background: linear-gradient(to top, #3aafa9 -30%, #ffffff 120%)" onload='phone_upload ()'>
    <script>
        ...
        <header>
            <nav class="navbar navbar-expand-lg  nav-info mb-3 bg-info">
              ...
              <div class="collapse navbar-collapse w-100  p-1 rounded " id="navbarTogglerDemo02">
                <ul class="navbar-nav  ">
                  ...
                  <li class="nav-item">
                    <button type="button" class="btn buttons mx-3 font-weight-bolder   " id="license_button">License<i class="mx-2 fa fa-drivers-license-o"></i></button>
                ...
                <div class="col-sm-12  w-100">
                  <form class="form-inline" action="/action_page.php">
                    <div class="input-group w-100  ">
                      <input class="form-control border border-light "  type="search" id="search-bar"  placeholder="Search">
  ...
  <div class="modal fade rounded" id="profile_view">
      <div class="modal-dialog  modal-lg modal-dialog-centered">
        <div class="modal-content">
          ...
          <div class="modal-body rounded   " style="  background: linear-gradient(to top, #3aafa9 -30%, #ffffff 120%)">
...
<!--##################################### home content ##################################################################################################### -->
            ...
            <div class="conatiner-fluid  p-3" id="home_content">
              <div class="row">
                ...
                <div id="myprofile" class="col-lg-2  d-lg-block h-50 collapse rounded textcolor shadow-lg p-4 mb-4  mx-3 " style=" background: linear-gradient(to top, #3aafa9 -50%, #ffffff 99%)">
                    ...
                    <div class="row">
                      ...
                      <ul class=" list-unstyled">
                        ...
                        for($i=0;$i<count($address);$i++)
                        {
                          echo
                          '
                          <li class=" text-dark  font-weight-bold  small my-1"><span class="   fas fa-home mx-2"></span> '.$address[$i].'</li>
 ...
 <!--##################################### upload content ##################################################################################################### -->
          ...
          <div class="container-fluid  px-5  " id="uploads_content" style="display:none;">
            <div class="row shadow-lg  rounded" style=" background: linear-gradient(to top, #3aafa9 -30%, #ffffff 120%)">
                ...
                <div class="col-lg-6 " id="valuation_form">
                    <form action="php/upload_valuation.php" method="POST" enctype="multipart/form-data" name="valuation_form_AVC">
                        ...
                        <div class="form-group  py-2">
                          ...
                          <div class="form-group  py-2">
                            ...
                            <input type="text" class="mx-auto form-control w-100 " name="account_type" hidden  id="" value="AVC">
 ...
 <div class="container-fluid  px-5  " id="valuation_content" style="display:none;">
  <div class="row shadow-lg  rounded " style=" background: linear-gradient(to top, #3aafa9 -50%, #ffffff 99%)">
    <div class="container-fluid py-5">
      <div class="row ">
        <div class="col-lg-5 d-flex align-items-center p-5  ">
        ...
        <div class="col table-responsive-lg  rounded " id="valuation_table">
          <table class="table table-info bg-info rounded table-hover table-striped">
...
<div class="container-fluid  " id="edit_profile" style="display:none">
  <div class="container rounded  shadow-lg " style="background: transparent;">
    <div class="row ">

    <div class="col-lg-8 ">
      <form name="update_Company"  class =" py-3 " method ="POST" action="php/update_account.php" enctype="multipart/form-data">

        <div class="form-group py-0">
          <div class=row>
            <div class="form-group col-lg  py-2">
                <label for="fullname" class="font-weight-bolder">Name:</label>
                <input type="text" class="form-control w-100"  onkeyup='fname_validation("update_Company")' value="<?php echo $name?>" placeholder="Enter name" id="cfirstname" name="name" required>
            </div>
        </div>
      </div>
      ...
      <div class="form-group py-0">
        <div class=row>
          <div class="form-group col-lg  py-2">
            ...
            <input type="password"  value="<?php echo $pwd?>" class="mx-auto form-control w-100 " onblur='validation_Cpassword("update_Company",0)' placeholder="Enter password" id="cpwd" name="password" required>
          ...
          <div class="form-group col-lg py-2">
            ...
            <input type="password"   value="<?php echo $pwd?>" class="mx-auto form-control w-100 "  onblur='validation_Cpassword("update_Company",0)' placeholder="re Enter your password" id="crepwd" name="repassword" required>
      ...
      <div class="form-group  py-2">
          ...
          <input type="email" value="<?php echo $email?>" class=" mx-auto form-control w-100 " onblur='validation_Cemail("update_Company",0)'  placeholder="Enter email" id="cemail" name="email" required>
      ...
      <div class="form-group py-2">
        <div class=row>
          ...
          <div class="col-lg-4">
            <input type ="button"  name="add_phone" value=" +ADD " data-toggle="modal" data-target="#addphone" style="width: 100px;"  class="mx-auto btn btn-primary  my-4">
      ...
      <div class="form-group py-2">
        <div class=row>
          <div class="col-lg-8">
            <label for="tel" class ="font-weight-bolder">Address</label>
          
            <span id="address_location"class=" phone_location btn bg-danger fa fa-warning py text-white my-2 font-weight-bolder" style="display :none;"></span>
            <div class="container" class="phonenumberdisplay" id="addressdisplay" >
       ...
       <div class=" container d-flex flex-row-reverse ">
        <input type ="submit"  name="update_Company" value=" update " style="width: 100px;"  class=" signups mx-4 btn btn-success my-4">
...
<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% holds type of account and serial%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
      ...
      <input type="text" class="mx-auto form-control w-100 "  hidden value="<?php echo $AVC_ID?>"  name="ID" >
      <input type="text" class="mx-auto form-control w-100 "  hidden value="AVC"  name="Account_type" >
    </form>
     ...
     <button type="button" class="close my-2 text-white" data-dismiss="modal">&times;</button>
        ...
        <div class="container">
          ...
          <form name="addphone_number" method="POST" action="php/phone_number_load.php" enctype="multipart/form-data" >
            ...
            <input type="text" class="mx-auto form-control w-75 " value="AVC" name='ACCtype' hidden >
            <span id="phone_location"class=" phone_location btn bg-danger fa fa-warning py text-white my-2 font-weight-bolder" style="display :none;"></span>
...
<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% end of modal that  hold  add phone %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
...
<div class="container-fluid p-2" id="license_form_content" style="display:none">

    <div class="container p-3" id="licesne_upload_from">
        <div class="row">
            <div class="col-lg-7">
                <form name ="license upload" method="POST" action="php/license_request.php" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="Discription " class="font-weight-bolder">Request Discription:</label>
                        <textarea class="form-control" rows="6" name="discription" id="comment" required></textarea>
                      </div>
                    
                     <label class="font-weight-bolder">upload pictures of License: </label>
                      <div class="custom-file">
                        <input type="file" name="license_pic[]" onchange="loadFile(event,1)"  multiple class="asset_pic custom-file-input" id="customFile">
                        ...
                        <div class=" container d-flex flex-row-reverse ">
                            <input type ="submit"  name="upload_License" value="Send" style="width: 100px;"  class="  mx-4 btn btn-success my-4">
                            <input type ="reset" value ="reset" style="width: 100px;" width="100px"name= "rest" class="mx-4  btn btn-primary my-4">
            ...
            <div class="col-lg-5 ">
                <div  class="container rounded p-0 border mx-1 my-3"style="width:300px;height: 350px; " >
                    ...
                    <img id="" class="forpic img-fluid   " style="width:300px;
                    height: 350px; " src="" alt="License_pic">
...
<div class="container ">
  <div class="row">
    ...
    <div class="col-lg-12  " id="license_result_display">
