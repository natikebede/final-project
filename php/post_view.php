...
if(isset($_POST['true']))
{
  ...
  while($row=$result->fetch_assoc())
  {
    ...
    if($result1 && $result1->num_rows >0)
    {
      ...
      echo'
      <div class="container-fluid my-3 rounded bg-dark  text-light shadow-lg p-3">
  ...
  if($result2->num_rows >2)
  {
    echo'
    <div class="container">
    <div id="demo-'.$post_ID.'" class="carousel slide w-100 bg-dark rounded" data-ride="carousel">
 ...
 { 
  $post_ID=$_POST['Post_ID'];
   ...
   if($result->num_rows >0)
   {
    while( $row=$result->fetch_assoc())
    {
      $no_views=$row['No_views'];
    }
    $no_views++;
    $sql1="UPDATE post SET No_views='$no_views' WHERE  Post_ID='$post_ID'";
    ...
    if($result2->num_rows >2)
    {
      ...
      <div id="demo" class="carousel slide w-100 bg-dark rounded" data-ride="carousel">
